...
function container(password: string, options?: { noKey?: boolean; mismatch?: boolean; expired?: boolean }) {
  ...
  const asn1 = forge.pkcs12.toPkcs12Asn1(options?.noKey ? null as any : pair.privateKey, cert, password);
