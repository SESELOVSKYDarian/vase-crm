...
async function main() {
  const permissionKeys = [
    ...
    "prices.view", "prices.manage", "production.view_all", "production.view_assigned", "production.assign", "production.update_assigned", "production.work_order.status.update", "production.progress.view", "production.cut.progress.update", "production.assembly.progress.update", "production.production.progress.update", "credit_notes.view", "credit_notes.create", "debit_notes.view", "debit_notes.create", "fiscal_documents.print",
  ...
  const rolePermissions: Record<string, string[]> = {
    ...
    ATENCION_CLIENTE: ["clients.view", "clients.create", "clients.edit", "clients.delete", "quotes.view", "quotes.create", "quotes.edit", "quotes.delete", "quotes.send", "quotes.approve", "quotes.reject", "prices.view", "prices.manage", "production.view_all", "production.assign", "deliveries.view", "deliveries.create", "deliveries.edit", "remitos.view", "remitos.create", "remitos.confirm", "remitos.cancel", "invoices.view", "invoices.create", "invoices.authorize", "payments.view", "payments.create", "payments.edit", "payments.cancel", "account.view", "account.manage", "analytics.view", "notifications.view", "notifications.manage_own", "credit_notes.view", "credit_notes.create", "debit_notes.view", "debit_notes.create", "fiscal_documents.print"],
