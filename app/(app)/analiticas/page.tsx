...
function Loading() { return <div className="flex h-full items-center justify-center rounded-xl bg-secondary/35 text-sm text-muted-foreground">Cargando gráfico…</div>; }
function ErrorState({ text }: { text: string }) { return <Card><CardContent className="p-6 text-sm text-destructive">{text}</CardContent></Card>; }
