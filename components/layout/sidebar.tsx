  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "fixed inset-0 z-40 bg-slate-950/35 backdrop-blur-[2px] lg:hidden",
      ...
      >
        <motion.div
          ...
          initial={false}
          animate={{ width: mobileOpen || !collapsed ? 280 : width }}
          transition={
            reduceMotion
              ? { duration: 0 }
          ...
          className={cn(
            "fixed inset-y-0 left-0 z-50 flex h-[100dvh] flex-col overflow-hidden border-r border-slate-200/80 bg-white shadow-[12px_0_40px_-26px_rgba(15,23,42,.42)] dark:border-slate-800 dark:bg-slate-950 lg:sticky lg:top-0 lg:translate-x-0",
        ...
        >
          <div className="flex h-[76px] shrink-0 items-center gap-3 border-b border-slate-200/80 px-[18px] dark:border-slate-800">
            <motion.div
              whileHover={
                reduceMotion ? undefined : { scale: 1.04, rotate: -4 }
              }
            ...
            >
              <p className="text-[15px] font-bold tracking-[-0.02em] text-slate-950 dark:text-white">
                Vase
              </p>
            ...
            <button
              ...
              className="ml-auto flex h-10 w-10 items-center justify-center rounded-xl text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-950 focus-visible:ring-2 focus-visible:ring-vase-green lg:hidden"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
            ...
            {nav.filter((item) => {
              ...
              return (
                <Link
                  ...
                  className={cn(
                    "group relative flex h-11 items-center gap-3 rounded-xl px-2.5 text-sm font-medium outline-none transition-colors duration-150",
                    active
                      ? "text-vase-green"
                ...
                >
                  {active && (
                    <motion.span
                      ...
                      className="absolute inset-0 rounded-xl bg-vase-green-soft"
                    />
                  )}
          ...
          <div className="shrink-0 border-t border-slate-200/80 p-3 dark:border-slate-800">
            <motion.div
              animate={{ opacity: expanded || mobileOpen ? 1 : 0 }}
              className="rounded-xl bg-slate-100 px-3 py-3 dark:bg-slate-900"
            >
              <p className="text-xs font-semibold text-slate-900 dark:text-slate-100">
                WTA · Producción vidrio
              </p>
              <p className="mt-1 text-[11px] leading-4 text-slate-500">
                Homologación ARCA activa
              </p>
            </motion.div>
          </div>
        </motion.div>
